...
import { Clock, Users, BookOpen, ExternalLink, Download, FileText } from "lucide-react"
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-semibold leading-none tracking-tight text-heading-1 font-poppins", className)}
    {...props}
  />
))
...
const CourseCard = React.forwardRef<HTMLDivElement, CourseCardProps>(
  ({ className, title, description, level, duration, modules, image, ...props }, ref) => (
...
const VideoCard = React.forwardRef<HTMLDivElement, VideoCardProps>(
  ({ className, title, description, lesson, timestamp, thumbnail, ...props }, ref) => (
    <Card ref={ref} className={cn("hover:shadow-md transition-shadow", className)} {...props}>
      {thumbnail && (
...
const StudyCard = React.forwardRef<HTMLDivElement, StudyCardProps>(
  ({ className, title, description, fileType, fileSize, downloadLink, ...props }, ref) => (
    <Card ref={ref} className={cn("hover:shadow-md transition-shadow", className)} {...props}>
      <CardHeader>
        <div className="flex items-center gap-2 mb-2">
